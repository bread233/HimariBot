...
class Util:
    @staticmethod
    def trans_num_easy_for_read(num: Union[int, str]) -> str:
    ...
    @staticmethod
    def get_map_name(map_id: Union[str, int]) -> str:
    ...
    @staticmethod
    def get_armed_force_name(armed_force_id: Union[int, str]) -> str:
    ...
    @staticmethod
    def get_tdm_match_result(result: Union[int, str]) -> str:
