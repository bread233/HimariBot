...
from ..chat.message_receive.chat_manager import BotChatSession, chat_manager
from ..chat.message_receive.message import SessionMessage
from ..chat.utils.utils import get_bot_account, is_bot_self, is_mentioned_bot_in_message
...
from ..common.message_repository import find_messages
from ..common.utils.utils_config import ChatConfigUtils, ExpressionConfigUtils, JargonConfigUtils
from ..config.config import global_config
from ..core.tooling import ToolRegistry, ToolSpec
from ..learners.expression_learner import ExpressionLearner
from ..learners.jargon_miner import JargonMiner
from ..llm_models.payload_content.resp_format import RespFormat
from ..llm_models.payload_content.tool_option import ToolDefinitionInput
from ..mcp_module import MCPManager
from ..mcp_module.config import build_mcp_server_runtime_configs
from ..mcp_module.host_llm_bridge import MCPHostLLMBridge
from ..mcp_module.provider import MCPToolProvider
from ..plugin_runtime.tool_provider import PluginToolProvider
from ..plugin_runtime.hook_payloads import deserialize_prompt_messages
...
class MaisakaHeartFlowChatting:
    ...
    async def _restore_recent_context_from_db(self) -> None:
        ...
        for message in recent_messages:
            if getattr(message, "timestamp", None) is None:
                logger.warning(
                    "%s 跳过恢复的历史消息: message_id=%s session_id=%s timestamp 为空",
                    self.log_prefix,
    ...
    async def _recognize_sent_images(self, images: list[ImageComponent], message_id: str) -> None:
        ...
        from ..chat.image_system.image_manager import image_manager
