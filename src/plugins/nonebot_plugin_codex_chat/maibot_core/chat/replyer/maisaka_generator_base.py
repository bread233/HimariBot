...
from ..message_receive.chat_manager import BotChatSession
from ..message_receive.message import SessionMessage
from ..utils.utils import get_chat_type_and_target_info
from ...cli.console import console
from ...common.data_models.llm_service_data_models import LLMGenerationOptions
...
from ...common.data_models.reply_generation_data_models import (
    GenerationMetrics,
    LLMCompletionResult,
...
from ...common.utils.utils_config import ChatConfigUtils
from ...config.config import global_config
from ...config.model_configs import ModelInfo
from ...core.types import ActionInfo
from ...llm_models.payload_content.message import Message, MessageBuilder, RoleType
from ...maisaka.context_messages import (
    AssistantMessage,
    LLMContextMessage,
    ReferenceMessage,
...
from ...maisaka.display.prompt_cli_renderer import PromptCLIVisualizer
from ...maisaka.message_adapter import parse_speaker_content
from ...maisaka.planner_message_utils import extract_quote_ids_from_message_sequence
from ...maisaka.visual_message_limiter import limit_latest_images_in_messages
from ...plugin_runtime.hook_payloads import deserialize_prompt_messages, serialize_prompt_messages
...
class BaseMaisakaReplyGenerator:
    ...
    def _get_runtime_manager() -> Any:
        from ...plugin_runtime.integration import get_plugin_runtime_manager
